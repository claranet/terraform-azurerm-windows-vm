...
| key\_vault | Key Vault configuration for Virtual Machine WinRM certificate. Set to `null` to disable WinRM certificate entirely. | <pre>object({<br/>    id                         = string<br/>    rbac_authorization_enabled = optional(bool, true)<br/>    winrm_certificate_enabled  = optional(bool, true)<br/>  })</pre> | n/a | yes |
